...
LIBS += -Wl,--no-as-needed -fvisibility=default \
		...
		-Wl,--whole-archive -lrte_hash -lrte_lpm -lrte_kvargs -Wl,-lrte_mbuf -lrte_eal \
		-Wl,-lrte_mempool -lrte_ring -lrte_cmdline -lrte_cfgfile -lrte_kni \
		-lrte_timer -lrte_net -Wl,-lrte_pmd_virtio \
		-lrte_acl -lrte_sched -lrte_port -lrte_table -lqnsm_service \
